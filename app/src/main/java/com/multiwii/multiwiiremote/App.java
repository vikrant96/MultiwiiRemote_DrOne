...
public class App extends Application implements Sensors.MagAccListener {
	...
	//public CommunicationMode comMode;   //No mode required as only WIFI will be used.
	public String ssid;
	...
	public void ReadSettings() {
		...
		//comMode = CommunicationMode.valueOf(prefs.getString("comMode", "Wifi").toUpperCase(Locale.US));
		//updateComMode();

		//Only Wifi will be used
		initWifi();  //Update: Vikrant
	}
